...
def test_verify_valid_signature():
    ...
    assert Wallet.verfiy(wallet.public_key, data, signature)
...
def test_verify_invalid_signature():
     ...
     assert not Wallet.verfiy(Wallet().public_key, data, signature)
